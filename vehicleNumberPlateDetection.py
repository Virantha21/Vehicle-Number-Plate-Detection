...
def get_image():
    ...
    fileName = filedialog.askopenfilename(
        ...
        initialdir="D:/New folder (2)/Car-Number-Plate-Detection-OpenCV-Python-master", #this one should be changed according to local reference
    ...
    label_img = Label(new_window, image = selected_image)
...
img_label = ImageTk.PhotoImage(file = 'icon_image.jpg')
lab_im = Label(root, image = img_label, width="600", height="300")
